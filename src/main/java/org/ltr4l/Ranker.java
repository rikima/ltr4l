...
public abstract class Ranker<C extends Config> {
  ...
  public static class RankerFactory {
      ...
      public static Ranker getFromModel(String modelPath) throws IOException {
          ...
          return getFromModel(algorithm, modelPath);
      }
      ...
      public static Ranker getFromModel(String algorithm, String modelPath) {
          String alg = algorithm;
          try {
              Reader reader = new BufferedReader(new InputStreamReader(new FileInputStream(modelPath)));
              if (alg.equals("prank")) {
